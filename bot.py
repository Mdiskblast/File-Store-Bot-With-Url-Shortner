    ...
    if usr_cmd == "/start":
        ...
        await cmd.reply_text(
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                    [
                        InlineKeyboardButton("Updates Channel", url="https://t.me/+LeOTbICDc4cxNDMx")
                    ],
                    [
                    ...
                    [
                        InlineKeyboardButton("Support Group", url="https://t.me/+LeOTbICDc4cxNDMx"),
...
async def main(bot: Client, message: Message):
    ...
    if message.chat.type == enums.ChatType.PRIVATE:
        ...
        if message.from_user.id in Config.BANNED_USERS:
            await message.reply_text("Sorry, You are banned!\n\nContact [Admin](https://t.me/Capta1_n)",
                                     disable_web_page_preview=True)
            return
        ...
        await cmd.message.edit(
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                    ...
                    [
                        InlineKeyboardButton("Support Group", url="https://t.me/+LeOTbICDc4cxNDMx"),
                        InlineKeyboardButton("YouTube Link from Adminl", url="https://t.me/Capta1_n")
                    ]
                ]
            )
        )
        ...
        if Config.UPDATES_CHANNEL:
            ...
            try:
                ...
                if user.status == "kicked":
                    await cmd.message.edit(
                        text="Sorry Sir, You are Banned to use me. Contact my [ADMIN](https://t.me/Capta1_n).",
                        disable_web_page_preview=True
                    )
                    return
                ...
                await cmd.message.edit(
                    text="Something went Wrong. Contact my [ADMIN](https://t.me/Capta1_n).",
                    disable_web_page_preview=True
                )
                return
        await cmd.message.edit(
